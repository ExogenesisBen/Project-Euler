...
def alongRow(list1):
    ...
    while n<20:
        while m<17:
            x=list1[n][m]*list1[n][m+1]*list1[n][m+2]*list1[n][m+3]
            if x>biggestRow:
                biggestRow=x
            m+=1
        n+=1
...
def alongColumn(list1):
    ...
    while m<20:
        while n<17:
            x=list1[n][m]*list1[n+1][m]*list1[n+2][m]*list1[n+3][m]
            if x>biggestColumn:
                biggestColumn=x
            n+=1
        m+=1
...
def alongDiag1(list1):
    ...
    while n<17:
        while m<17:
            x=list1[n][m]*list1[n+1][m+1]*list1[n+2][m+2]*list1[n+3][m+3]
            if x>biggestDiag1:
                biggestDiag1=x
            m+=1
        n+=1
...
listgreat = [x],[y],[z],[w]
biggest = max(listgreat)
big = biggest[0]
print "The answer is: ", big
